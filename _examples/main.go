...
func colourblocks() {
	...
	fmt.Println("COLOURS BLOCK BLUE                 >", colours.Blocks("{{@brightblue}}{{@!BLANK(40)}}\n"))
	fmt.Println("COLOURS BLOCK MIXED                >", colours.Blocks("{{@brightblue}}{{@!BLANK(40)}}{{@red}}{{@!BLANK(40)}}\n"))
	fmt.Println("COLOURS BLOCK TEXT                 >", colours.Blocks("{{@brightblue}}This is a test.{{@red}}This is the second test"))
}
...
func emojiicons() {
	fmt.Println("")
	fmt.Println("EMOJI ASCII ICONS **********************************************")
	fmt.Println("EMOJI ICON TICK                    >", emoji.TICKSIMPLE, colours.Green(emoji.TICKSIMPLE), colours.BrightGreen(emoji.TICKSIMPLE))
	fmt.Println("EMOJI ICON CROSS                   >", emoji.CROSSSIMPLE, colours.Red(emoji.CROSSSIMPLE), colours.BrightRed(emoji.CROSSSIMPLE))
	fmt.Println("EMOJI ICON COPYRIGHT               >", emoji.COPYRIGHT)
	fmt.Println("EMOJI ICON REGISTREDTM             >", emoji.REGISTREDTM)
	fmt.Println("EMOJI ICON TRADEMARK               >", emoji.TRADEMARK)
	fmt.Println("EMOJI ICON BULLET                  >", emoji.BULLET)
	fmt.Println("EMOJI ICON ARROWLEFT               >", emoji.ARROWLEFTSIMPLE)
	fmt.Println("EMOJI ICON ARROWRIGHT              >", emoji.ARROWRIGHTSIMPLE)
	fmt.Println("EMOJI ICON ARROWUP                 >", emoji.ARROWUPSIMPLE)
	fmt.Println("EMOJI ICON ARROWDOWN               >", emoji.ARROWDOWNSIMPLE)
	fmt.Println("EMOJI ICON ARROWLEFTRIGHT          >", emoji.ARROWLEFTRIGHT)
	fmt.Println("EMOJI ICON INFINITY                >", emoji.INFINITY)
	fmt.Println("EMOJI ICON CELSIUS                 >", emoji.CELSIUS)
	fmt.Println("EMOJI ICON FAHRENHEIT              >", emoji.FAHRENHEIT)
	fmt.Println("EMOJI ICON SUNSHINE                >", emoji.SUNSHINE)
	fmt.Println("EMOJI ICON CLOUDY                  >", emoji.CLOUDY)
	fmt.Println("EMOJI ICON RAIN                    >", emoji.RAIN)
	fmt.Println("EMOJI ICON SNOW                    >", emoji.SNOW)
	fmt.Println("EMOJI ICON STAR BLACK              >", emoji.STARBLACK)
	fmt.Println("EMOJI ICON STAR WHITE              >", emoji.STARWHITE)
	fmt.Println("EMOJI ICON PHONE BLACK             >", emoji.PHONEBLACK)
	fmt.Println("EMOJI ICON PHONE WHITE             >", emoji.PHONEWHITE)
	fmt.Println("EMOJI ICON POINT LEFT              >", emoji.POINTLEFT)
	fmt.Println("EMOJI ICON POINT RIGHT             >", emoji.POINTRIGHT)
	fmt.Println("EMOJI ICON POINT UP                >", emoji.POINTUP)
	fmt.Println("EMOJI ICON POINT DOWN              >", emoji.POINTDOWN)
	fmt.Println("EMOJI ICON DEATH                   >", emoji.DEATH)
	fmt.Println("EMOJI ICON SMILEY                  >", emoji.SMILEY)
	fmt.Println("EMOJI ICON HEART                   >", emoji.HEART)
	fmt.Println("EMOJI ICON DIAMOND                 >", emoji.DIAMOND)
	fmt.Println("EMOJI ICON SPADE                   >", emoji.SPADE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLUB)

	fmt.Println("EMOJI ICON CLUB                    >", emoji.ARROWBACKWARD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ARROWDOWNWARDS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ARROWFORWARD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ARROWUPWARDS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ARROWDOWNWARD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ARROWLEFT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ARROWRIGHT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ARROWUP)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ASTERISK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BALL8)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ALIEN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.APPLE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ANCHOR)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ANGEL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ANGRY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.AMAZED)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BABY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BABYCHICK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BALLOON)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BANANA)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BANK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BAT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BATTERY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BEER)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BEERS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BELL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BIKE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BLACKFLAG)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BLACKHEART)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BLOSSOM)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BLOSSOM2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BLUSH)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BOMB)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BRIEFCASE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BULB)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BUS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.BUTTERFLY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CAKE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CALENDAR1)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CALENDAR2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CALLME)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CAMEL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CAMERA)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CAMPING)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CANDY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CANOE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CAR1)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CAT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CHAINS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CHAMPAGNE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CHECK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CHICKEN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CHRISTMASTREE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLAP)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLAPPER)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLIPBOARD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLOCK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLOWNFACE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLOUD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLOUDLIGHTING)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLOUDLIGHTINGRAIN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLOUDRAIN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLOUDSNOW)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CLUBS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.COCKTAIL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CONFUSED)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CONSTRUCTION)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.COUPLE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.COW)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CRAB)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CREDITCARD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CROCODILE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CROSS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CROSSEDFINGERS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CROWN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.CRY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SUNGLASSES)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DART)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DESKTOP)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DIAMONDS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DISAPPOINTED)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DISSAPOINTEDRELIVED)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DIZZY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DOG)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DOLPHIN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DOOR)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DOUGHNUT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DOVE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DRAGON)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DRESS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DROP)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DROOLING)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.DUCK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.EAGLE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.EAR)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.EARTH)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.EGG)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ELEPHANT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.EMAIL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.EXPRESSIONLESS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.EYE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.EYES)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FIRE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.GLASSES)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FEAR)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FILECABINET)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FINISHFLAG)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FIREENGINE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FISH)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FIST)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FOGGY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FOOTBALL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FOOTPRINTS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FROG)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.FROWING)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.GEM)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.GHOST)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.GIFT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.GOAT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.GOLF)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.GORILLA)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.GRIN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.GUARD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.GUN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HAMBURGER)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HANDSHAKE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HEAD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HEADPHONES)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HEADS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HEARTS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HEARTEYES)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HOURGLASS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HOUSE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HUGS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.HUSHED)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.INNOCENT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.JOY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.JOYCAT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.KEY1)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.KEY2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.KISS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.KISSINGHEART)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.LAUGHING)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.LION)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.LOCK1)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.LOCK2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.MASK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.MEDAL1)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.MEDAL2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.METAL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.MICROPHONE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.MONKEY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.MOON)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.MOTAR)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.MOUSE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.MUSCLE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.MUSHROOM)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.NEUTRAL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.NOMOUTH)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.OCEAN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.OK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.OPENHAND)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.OWL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PANDA)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PEAR)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PEPPER)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PHONE1)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PHONE2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PIANO)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PIG)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PIZZA)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PLANE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.POINTDOWN2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.POINTLEFT2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.POINTRIGHT2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.POINTUP2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.POLICE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.POLICECAR)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PRAY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PRINTER)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.PUNCH)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RABBIT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RACECAR)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RAGE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RAINBOW)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RAISEDBACKHAND)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RAISEDHAND)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RAISEDHANDSPRAYED)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RAISEDHANDS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RELAXED)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RELIVED)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RIBBON)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ROBOT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ROCKET)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ROFL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ROLLEYES)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ROSE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RUGBY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.RUGBY2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SANTA)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SCREAM)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SEENOEVIL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SHAMROCK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SHEEP)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SHELL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SHIELD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SHIP)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SKULL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SLEEPING)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SLEEPY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SMILE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SMILEY2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SMIRK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SNAIL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SNEEZE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SNOWFLAKE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SNOWMAN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SPADES)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SPEACH)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SPEAKNOEVIL)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SOB)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.STAR)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.STAR2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.STOP)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.STRAWBERRY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SUNBEHINDCLOUD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SUNBEHINDLARGECLOUD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SUNBEHINDRAINCLOUD)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SUNFLOWER)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SUNGLASSES2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SUNNY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.SWIMMING)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TANGERINE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TAXI)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TEA)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TENNIS)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TENT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TICKET1)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TICKET2)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.THINKING)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.THUMBSUP)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.THUMBSDOWN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TIGER)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TIRED)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TOMATO)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TONGUEOUT)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TRAIN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TREE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TROLLEY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TROPHY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.TRUCK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.UPSIDEFACE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.VULCAN)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.WAVE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.WEARY)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.WHALE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.WINE)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.WINK)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ZAP)
	fmt.Println("EMOJI ICON CLUB                    >", emoji.ZZZZ)
}
